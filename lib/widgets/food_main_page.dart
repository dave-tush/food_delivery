...
Widget foodMainPage(BuildContext context) {
  return TweenAnimationBuilder(
    tween: Tween(begin: 0.0,end: 1.0),
    duration: Duration(seconds: 1),
    builder: (BuildContext context, _value,child){
      double _newValue = _value as double;
      return Opacity(opacity: _newValue,child: child,);
    },
    child: Column(
      children: [
        Container(
